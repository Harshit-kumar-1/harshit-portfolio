                    ...
                    <div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
                        <motion.div
                            ...
                            <a href={project.link} target="_blank" rel="noopener noreferrer">
                                <img src={project.image} alt={project.title} width={150} height={150} className='mb-6 rounded cursor-pointer' />
                            </a>
                        </motion.div>
                        <motion.div
                            whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <a href={project.link} target="_blank" rel="noopener noreferrer">
                                <h6 className='mb-2 font-semibold cursor-pointer'>{project.title}</h6></a>
